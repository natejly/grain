...
# without stopping to ask — but the specs below it are largely *about* the
# approval flow: approving a create_document, denying an edit, plan mode, the
# todos queue. None of them have a card to click if nothing parks. A spec that
# wants the bypass sets the mode itself.
