...
Revises: 0066_coworking

Renumbered from 0064 at merge time, per the branch convention: a branch keeps
its own numbering in flight and re-parents onto the then-current head when it
lands. Three other branches also claimed 0064. The backfill below stays sound
after the move because nothing in 0064-0066 introduces the safe_mode
preference, so no member can have opted in before this runs.
"""
...
revision = "0067_safe_mode"
down_revision = "0066_coworking"
branch_labels = None
depends_on = None
