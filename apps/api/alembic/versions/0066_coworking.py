...
Revision ID: 0066_coworking
Revises: 0065_delivery_hardening

Renumbered from 0049 at merge time, per the branch convention: a branch keeps
its own numbering while in flight and is re-parented onto the then-current head
when it lands. Its original parent, 0048_api_tokens, was itself renumbered when
the four-branch integration landed.
"""
...
revision = "0066_coworking"
down_revision = "0065_delivery_hardening"
branch_labels = None
depends_on = None
