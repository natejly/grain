...
import { BarChart3, ChevronDown, ChevronRight, CircleDot, Columns2, FolderInput, FolderMinus, Layers, LogOut, Menu, MessageSquareText, MoreHorizontal, Pencil, Plus, Share2, ShieldAlert, Trash2, Users, X } from "lucide-react";
...
export function Workspace() {
  ...
  const waitingRows = waitingOnMe.filter((row) => !snoozedApprovals.has(row.id));
